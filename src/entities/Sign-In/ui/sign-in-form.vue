<template>
  <div class=" sm:mt-10 flex justify-center items-center">
    <div class="w-full h-full  bg-[#F6F9FE] p-8 sm:w-[464px] sm:h-[486px] rounded-lg">
      ...
      <div class="mt-8">
        <form class="max-w-sm mx-auto">
          ...
          <Button class="mt-8 w-full" title="Kirish" color="#fff" bg-color="#1272CC"/>
