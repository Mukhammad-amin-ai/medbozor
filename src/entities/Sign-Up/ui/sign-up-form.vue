<template>
  <div class="mt-10 pb-[62px] flex justify-center items-center">
    <div class="bg-[#F6F9FE] p-8 w-[464px] rounded-lg">
      <div class="text-2xl font-semibold">
        Ro’yxatdan o’tish
      </div>
      <div class="mt-8">
        <form class="max-w-sm mx-auto">
          <div class="mb-7 flex items-center gap-7 ">
            <div>
          ...
          <div class="flex items-start mb-5">
            ...
            <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Xizmat va shartlarga rozilik bildirasizmi?</label>
          </div>
          <Button class="mt-7 py-4 w-full" title="Ro’yxatdan o’tish" color="#fff" bg-color="#1272CC"/>
